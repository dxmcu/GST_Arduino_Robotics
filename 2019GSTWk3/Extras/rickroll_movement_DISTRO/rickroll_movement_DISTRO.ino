...
#define rest    -1
#include <Adafruit_MotorShield.h> //includes motor libary

Adafruit_MotorShield AFMS = Adafruit_MotorShield();

const byte FORWARD_SPEED = 90;
const byte BACKWARD_SPEED = 90;
...
void loop(){
  /*
    motorLeft->setSpeed(FORWARD_SPEED); //Sets motor speed
  motorRight->setSpeed(FORWARD_SPEED);

  
    motorLeft->run(FORWARD); //spin indefinetly
